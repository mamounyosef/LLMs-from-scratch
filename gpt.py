...
class GPTLanguageModel(nn.Module):
    ...
    def generate_streaming(self, start_text="", max_new_tokens=1000, print_every=10):
        self.eval()
        
        # Encode starting text or use empty context
        if start_text:
